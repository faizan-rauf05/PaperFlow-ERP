...
export async function createProductionOrder({ customerId, salesRep, assignedWorkerId, notes, lines }) {
...
export async function getStageRecordContext(orderId, stageId) {
  ...
  return {
    ...
    paperStock,
    suggestedCutWidthMm: orderLine?.widthMm != null ? Number(orderLine.widthMm) : null,
  };
}
